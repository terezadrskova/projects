...
def compare_signatures(ls1, ls2):
    ...
    for i in range(len(histogram_ls1)):
        dist += (histogram_ls1[i]-histogram_ls2[i])**2
...
def get_shift(ls1,ls2):
    ...
    return (360 - orientation) #In degrees
...
###########
    #learn_location()
    #loc4_180 = signatures.read(5)
    #index, orientation = recognize_location2(loc4_180)
